...
public class expenseTransactionsAdapter extends RecyclerView.Adapter<expenseTransactionsAdapter.ViewHolder> {
    ...
    public expenseTransactionsAdapter(List<dataClass> dataClasses, OnItemClickListener itemClickListener, OnItemLongClickListener itemLongClickListener) {
